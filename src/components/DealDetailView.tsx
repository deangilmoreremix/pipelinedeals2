          ...
          <div className="p-8 flex-1 overflow-y-auto">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                {/* AI Tools Section - Uses the CustomizableAIToolbar component */}
                <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-blue-50">
                  <h4 className="text-sm font-bold text-gray-900 mb-3 flex items-center">
                    <Brain className="w-4 h-4 mr-2 text-purple-600" />
                    AI Assistant Tools
                ...
                {contactData && (
                  <div className="p-4 border-b border-gray-100 bg-white">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button 
                        onClick={() => {/* Open contact detail view */}}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Company</p>
                          <p className="text-sm font-medium text-gray-900">{contactData.company}</p>
                        </div>
                      </div>

                      {/* Social Profiles */}
                      {contactData.socialProfiles && Object.keys(contactData.socialProfiles).length > 0 && (
                        <div className="flex items-center space-x-3 min-w-0">
                          <div className="w-6 h-6 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                            <Globe className="w-3 h-3 text-purple-600" />
                          </div>
                          <div className="min-w-0 flex-1">
                            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Social</p>
                            <div className="flex space-x-2 mt-1">
                              {contactData.socialProfiles.linkedin && (
                                <a 
                                  href={contactData.socialProfiles.linkedin}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()}
                                  className="p-1.5 bg-blue-500 rounded-md text-white"
                                >
                              ...
                              {contactData.socialProfiles.twitter && (
                                <a 
                                  href={contactData.socialProfiles.twitter}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()}
                                  className="p-1.5 bg-blue-400 rounded-md text-white"
                                >
                                  <Twitter className="w-3 h-3" />
                                </a>
                              )}
                              {contactData.socialProfiles.website && (
                                <a 
                                  href={contactData.socialProfiles.website}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()}
                                  className="p-1.5 bg-purple-500 rounded-md text-white"
                                >
                      ...
                      {contactData.lastConnected && (
                        <div className="flex items-center space-x-3 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Last Connected</p>
                            <p className="text-sm font-medium text-gray-900">{contactData.lastConnected}</p>
                          </div>
                        </div>
                      )}
                    </div>
